...
export function guestLink(name:string,id:string){const u=new URL("/dilla-bobby/",(env as unknown as {SITE_ORIGIN:string}).SITE_ORIGIN);u.searchParams.set("to",name);return u.toString();}
